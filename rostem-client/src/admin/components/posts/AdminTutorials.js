...
class TutorialsTable extends React.Component {
  state = {
    order: "asc",
    orderBy: "name",
    selected: [],
  ...
  async handleDeleteTutorials() {
    const { selected } = this.state;
    await axios
      .delete(rostemConstants.BASE_URL + "/admin/deleteTutorials", {
        data: { ids: selected }
      })
                  ...
                  .map(n => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="justify">{n.categoryName}</TableCell>
                      </TableRow>
                    );
                  })}
                {emptyRows > 0 && (
...
TutorialsTable.propTypes = {
  classes: PropTypes.object.isRequired
};

export default withStyles(styles)(TutorialsTable);
